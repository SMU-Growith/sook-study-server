...
public class StudyApplicationConverter {
    ...
    public static StudyApplicationResponseDTO.MyApplicationCardDTO toMyApplicationCardDTO(
        ...
        return StudyApplicationResponseDTO.MyApplicationCardDTO.builder()
                ...
                .studyFormat(study.getStudyFormat() != null ? study.getStudyFormat().getDescription() : null)
                .studyFieldName(study.getStudyField() != null ? study.getStudyField().getName() : null)
                .studyStyleCategory(study.getStudyStyleCategory() != null ? study.getStudyStyleCategory().getDescription() : null)
